...
License: https://gist.github.com/vxgmichel/13bb00666430ab8dcc47d1f7dd148579
...
async def open_local_endpoint(host='0.0.0.0', port=0, *, queue_size=None, **kwargs) -> LocalEndpoint:
...
async def open_remote_endpoint(host, port, *, queue_size=None, **kwargs) -> RemoteEndpoint:
